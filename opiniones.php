            ...
            <?php foreach($usuarios as $u): ?>
                <?php if($u['id'] == $r['id_cliente']): ?>
                    <div class="opinion-container">
                        ...
                        <p class="mensaje"><?= $r['comentarion'] ?></p>
                        <p class="opinion-correo"><?= $u['correo'] ?></p>
                        <p class="estrellas">
                            <?php for($i = 0; $i < $r['calificacion']; $i++):?>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16" color="#eb9ac0">
